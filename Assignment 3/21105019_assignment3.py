...
#Question8A
print("Question 8A(in Set1 and Set2 but not both)")
set4=(Set1)&(Set2)
set5=(Set1)|(Set2)
print(set5-set4)
#Question8B
print("Question 8B(in only one of the three sets Set1,Set2 and Set3)")
set6=Set3|set5
set7=(Set1)&(Set3)
set8=set6-set7-set4
print(set8)
#Question8C
print("Question 8C(in exactly two sets of Set1,Set2,Set3)")
set9=set6-set8
print(set9)
#Question8D
print("Question 8D(integers in range 1-10 not in Set1)")
print(Integers-Set1)
#Question8E
print("Question 8E(integers in range 1-10 not in Set1,Set2,Set3)")
print(Integers-set6)
